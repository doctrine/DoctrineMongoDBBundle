...
class ContainerTest extends TestCase
{
    public function getContainer()
    {
        ...
        $extension->load(array(array(
            ...
            'document_managers' => array('default' => array('logging' => 'standard', 'mappings' => array('YamlBundle' => array()))),
        )), $container);
    ...
    public function testContainer()
    {
        ...
        $this->assertInstanceOf('Symfony\Bundle\DoctrineMongoDBBundle\Logger\StandardLogger', $container->get('doctrine.odm.mongodb.logger'));
