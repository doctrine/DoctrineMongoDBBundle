...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $documentManagerName = $input->getOption('dm') ?
            $input->getOption('dm') :
            $this->getContainer()->get('doctrine.odm.mongodb')->getDefaultDocumentManagerName();

        /* @var $documentManager Doctrine\ODM\MongoDB\DocumentManager */
        $documentManager = $this->getContainer()->get('doctrine.odm.mongodb')->getDocumentManager($documentManagerName);
